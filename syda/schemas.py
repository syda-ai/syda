...
class ModelConfig(BaseModel):
    ...
    deepseek_api_key: Optional[str] = Field(None, description="API key for DeepSeek provider")
    ...
    def get_model_kwargs(self) -> Dict[str, Any]:
        ...
        if self.provider == "openai":
            ...
            # might require to customize parameters
            # DeepSeek block: consistent with others
