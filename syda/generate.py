...
class SyntheticDataGenerator:
        ...
        Args:
            model_config: Configuration for the AI model to use, either as a ModelConfig object
                         ...
                         Supported models:
                             ...
                             - DeepSeek: e.g., "deepseek-coder", "deepseek-chat"
    ...
    def _call_deepseek_api(prompt, model_name, api_key):
    ...
    def _generate_data_with_llm(prompt, provider, model_name, api_key):
        ...
        Args:
            ...
            provider (str): "openai", "anthropic", or "deepseek".
        ...
        try:
            if provider == "openai":
                ...
                try:
                    return _call_deepseek_api(prompt, model_name, api_key)
                except Exception as e:
                    raise ValueError(f"Error generating data: {str(e)}")
            else:
