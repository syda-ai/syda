...
- **claude-haiku-4-5-20251001**: Fast and efficient for quick data generation (8,192 tokens)
- **claude-sonnet-5**: Balance of quality and performance (64,000 tokens)
- **claude-opus-5**: Highest capability for complex data (32,000 tokens)
