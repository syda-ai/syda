...
- **gpt-5**: Versatile, balanced model for most data generation use cases (16,000 tokens)
- **gpt-5-pro**: Highest capability model for complex data and larger datasets (100,000 tokens)
...
The gpt-5-pro model can handle generating larger datasets in a single request, which is more efficient than making multiple smaller requests.
...
1. **Choose the right model for your task**: 
   - Use gpt-5 for balanced performance and quality
   - Use gpt-5-pro for complex data structures and larger datasets
