...
config = ModelConfig(
    provider="grok",
    model_name="grok-4.3",  # Using Grok-4 (latest model)
    temperature=0.7,
    max_tokens=4000,
    extra_kwargs={
...
- `test_grok_models/grok-4.3/` - Grok-4.3 outputs

## Grok Model Configuration

SYDA supports xAI Grok models:

- **grok-4.3**: Latest xAI model for high-quality data generation with OpenAI-compatible API
